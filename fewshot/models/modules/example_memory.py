...
class ExampleMemory(ContainerModule):
  ...
  def forward(self, x, y, t, *states, **kwargs):
    ...
    y_ = self.retrieve(x, t, *states, **kwargs)
    states = self.store(x, y, t, *states, **kwargs)
    return y_, states
  ...
  def retrieve(self, x, t, *states, **kwargs):
  ...
  def infer(self, x, t, *states, **kwargs):
  ...
  def store(self, x, y, t, *states, **kwargs):
