...
from fewshot.models.modules.film_batch_norm import FilmBatchNorm
...
class ResidualModule(ContainerModule):
  ...
  def __init__(self,
    ...
    if norm == "batch_norm":
      ...
      norm_fn = SyncBatchNorm
      # assert False
    elif norm == "film_batch_norm":
      norm_fn = FilmBatchNorm
      assert False
